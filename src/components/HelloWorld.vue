  ...
  <div class="bg-gray-900">
    <main>/
        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
          <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
            ...
            <div class="mt-24 sm:mt-32 lg:mt-16">
              <a href="#" class="inline-flex space-x-6">
                ...
                <span class="inline-flex items-center space-x-2 text-sm font-medium leading-6 text-gray-300">
                  <span>Newest Examples</span>
                  <ChevronRightIcon class="h-5 w-5 text-gray-500" aria-hidden="true" />
                </span>
              </a>
            </div>
            <h1 class="mt-10 text-4xl font-bold tracking-tight text-center text-white sm:text-6xl">Longitudinal Analysis</h1>
            <p class="mt-6 text-lg text-center leading-8 text-gray-300">An open-source and collaborative effort <br>guided by the <b class="text-purple-200">Biostatistics Working Group </b> of the <br><b> <a href="https://abcdstudy.org/" class="text-indigo-500">Adolescent Brain Cognitive Development (ABCD) Study&reg</a></b></p>
            <div class="mt-10 flex items-center gap-x-6">
              ...
              <a href="#" class="text-sm font-semibold leading-6 text-white">Live demos <span aria-hidden="true">→</span></a>
            </div>
          </div>
      ...
      <div class="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
        <h2 class="text-center text-lg font-semibold leading-8 text-white">Special thanks to the support provided by the following groups</h2>
        <div class="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <a href="https://sunlab.fiu.edu" target="_blank">
          <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1" src="https://sunlab.fiu.edu/_assets/images/sun-lab-logo.jpg" alt="SUNLab" width="158" height="48" />
        </a>
        <a href="https://abcdstudy.org/" target="_blank">
          <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1" src="../assets/abcd-study-logo.png" alt="ABCD" width="158" height="48" />
          </a>
          <a href="https://www.laureateinstitute.org/population-neuroscience--genetics-center.html" target="_blank">
          <img class="col-span-2 max-h-12 w-full object-contain sm:col-start-2 lg:col-span-1" src="https://www.laureateinstitute.org/uploads/1/4/1/3/141382282/png-logo_1.png" alt="PNG" width="158" height="48" />
          </a>
          <a href="https://upennedenlab.com/" target="_blank">
          <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1" src="https://upennedenlab.com/wp-content/uploads/2022/09/logo-main-2x-logo.png" alt="EdenLab" width="158" height="48" style="background-color: white;" />
        </a>
        <a href="" target="_blank">
          <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1" src="../assets/begin.png" alt="SUNLab" width="158" height="48" />
        </a>
        </div>
      </div>
      ...
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
          <h2 class="text-base font-semibold leading-7 text-indigo-400">Deploy Longitudinal Models with Confidence</h2>
          <p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Streamline Analytic Workflows </p>
          <p class="mt-6 text-lg leading-8 text-gray-300">Resources to enhance reproducibility and replicability of longitudnal research.</p>
        </div>
      ...
      <div class="mt-32 sm:mt-56">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl sm:text-center">
            <h2 class="text-base font-semibold leading-7 text-indigo-400">Everything you need to get your analysis up and running</h2>
            <p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Don't see code for the longitudinal model you are looking for? <a href="https://github.com/openresearchcollabs/ABWG-Longitudinal/issues" target="_blank" class="underline">Issue a request.</a></p>
      ...
      <div class="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
          <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Want to Contribute?</h2>
    ...
    <footer aria-labelledby="footer-heading" class="relative">
      ...
      <div class="mx-auto max-w-7xl px-6 pb-8 pt-4 lg:px-8">
        <div class="border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; 2023 Longitudinal Analysis.</p>
        </div>
      </div>
    </footer>
  </div>
...
const primaryFeatures = [
  ...
  {
    name: 'Learn longitudinal methods',
    description:
...
const secondaryFeatures = [
  ...
  {
    name: 'Longitudinal Neuroimaging.',
    description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit aute id magna.',
  ...
  {
    name: 'Measurement and Psychometrics.',
    description: 'Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. ',
    icon: ServerIcon,
  },
]
const stats = [
  { id: 1, name: 'Examples included', value: '50+' },
  { id: 2, name: 'Total Contributors', value: '20+' },
  { id: 3, name: 'Uptime guarantee', value: '99.9%' },
  { id: 4, name: 'Languages', value: '5+' },
]
